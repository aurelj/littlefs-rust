...
#[tokio::test]
async fn test_compat_forward_mount() {
    let storage = compat_storage();
    c_impl::format(&storage).expect("C format");
    rust_impl::format_only(&storage).await.ok(); // just verify Rust can also format
...
#[tokio::test]
async fn test_compat_forward_read_dirs() {
    let storage = compat_storage();
    c_impl::format_create_n_dirs(&storage, 5).expect("C create dirs");
    rust_impl::mount_verify_n_empty_dirs(&storage, 5)
        .await
        .expect("Rust verify dirs");
}

/// Upstream: test_compat_forward_read_files
#[rstest]
#[tokio::test]
async fn test_compat_forward_read_files(#[values(4, 32, 512, 8192)] size: u32) {
    let storage = compat_storage();
    c_impl::format_create_n_files_prng(&storage, 5, size, CHUNK).expect("C create files");
    rust_impl::mount_verify_n_files_prng(&storage, 5, size, CHUNK)
        .await
        .expect("Rust verify files");
}

/// Upstream: test_compat_forward_read_files_in_dirs
#[rstest]
#[tokio::test]
async fn test_compat_forward_read_files_in_dirs(#[values(4, 32, 512, 8192)] size: u32) {
    let storage = compat_storage();
...
#[tokio::test]
async fn test_compat_forward_write_dirs() {
    let storage = compat_storage();
    c_impl::format_create_n_dirs(&storage, 5).expect("C create 5 dirs");
    rust_impl::mount_create_dirs_and_list(&storage, 5, 5, 10)
        .await
...
#[rstest]
#[tokio::test]
async fn test_compat_forward_write_files(#[values(4, 32, 512, 8192)] size: u32) {
    let storage = compat_storage();
...
#[rstest]
#[tokio::test]
async fn test_compat_forward_write_files_in_dirs(#[values(4, 32, 512, 8192)] size: u32) {
    let storage = compat_storage();
    c_impl::format_create_n_dirs_with_files_prng(&storage, 5, size, CHUNK)
...
#[tokio::test]
async fn test_compat_backward_mount() {
    let storage = compat_storage();
...
#[tokio::test]
async fn test_compat_backward_read_dirs() {
    let storage = compat_storage();
    rust_impl::format_create_n_dirs(&storage, 5)
        .await
        .expect("Rust create dirs");
...
#[rstest]
#[tokio::test]
async fn test_compat_backward_read_files(#[values(4, 32, 512, 8192)] size: u32) {
    let storage = compat_storage();
    rust_impl::format_create_n_files_prng(&storage, 5, size, CHUNK)
        .await
        .expect("Rust create files");
...
#[rstest]
#[tokio::test]
async fn test_compat_backward_read_files_in_dirs(#[values(4, 32, 512, 8192)] size: u32) {
    let storage = compat_storage();
...
#[tokio::test]
async fn test_compat_backward_write_dirs() {
    let storage = compat_storage();
    rust_impl::format_create_n_dirs(&storage, 5)
        .await
        .expect("Rust create 5 dirs");
...
#[rstest]
#[tokio::test]
async fn test_compat_backward_write_files(#[values(4, 32, 512, 8192)] size: u32) {
    let storage = compat_storage();
    rust_impl::format_create_n_files_prng(&storage, 5, size, CHUNK)
        .await
...
#[rstest]
#[tokio::test]
async fn test_compat_backward_write_files_in_dirs(#[values(4, 32, 512, 8192)] size: u32) {
    let storage = compat_storage();
    rust_impl::format_create_n_dirs_with_files_prng(&storage, 5, size, CHUNK)
        .await
