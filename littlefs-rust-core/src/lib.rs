...
pub fn lfs_rename(
    ...
    crate::fs::rename::lfs_rename_(lfs, caches, oldpath, newpath)
}
...
pub fn lfs_file_open(
    ...
    crate::file::ops::lfs_file_open_(lfs, caches, file, path as *const i8, flags)
}
...
pub fn lfs_file_opencfg(
    ...
    crate::file::ops::lfs_file_opencfg_(lfs, caches, file, path as *const i8, flags, config)
}
...
pub fn lfs_file_seek(
    ...
    crate::file::ops::lfs_file_seek_(lfs, caches, file, off, whence)
}
...
pub fn lfs_file_truncate(
    ...
    crate::file::ops::lfs_file_truncate_(lfs, caches, file, size)
}
...
pub fn lfs_dir_open(
    ...
    crate::dir::open::lfs_dir_open_(lfs, caches, dir, path)
}
...
pub fn lfs_dir_read(
    ...
    crate::dir::open::lfs_dir_read_(lfs, caches, dir, info)
}
...
pub fn lfs_dir_seek(
    ...
    crate::dir::open::lfs_dir_seek_(lfs, caches, dir, off)
}
