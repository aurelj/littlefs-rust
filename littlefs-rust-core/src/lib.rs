...
#[inline(never)]
pub async fn lfs_format<S: Storage>(
    lfs: &mut Lfs<S>,
    caches: &mut LfsCaches,
    config: *const LfsConfig,
) -> i32 {
    crate::lfs_trace!("lfs_format({:p}, {:p})", lfs, config);
    let err = crate::fs::lfs_format_(lfs, caches, config).await;
...
#[inline(never)]
pub async fn lfs_mount<S: Storage>(
    lfs: &mut Lfs<S>,
    caches: &mut LfsCaches,
    config: *const LfsConfig,
) -> i32 {
    crate::lfs_trace!("lfs_mount({:p}, {:p})", lfs, config);
    crate::fs::lfs_mount_(lfs, caches, config).await
}
...
#[inline(never)]
pub async fn lfs_remove<S: Storage>(
    lfs: &mut Lfs<S>,
    caches: &mut LfsCaches,
    path: *const u8,
) -> i32 {
    crate::fs::remove::lfs_remove_(lfs, caches, path).await
}
...
pub async fn lfs_rename<S: Storage>(
    ...
    crate::fs::rename::lfs_rename_(lfs, caches, oldpath, newpath).await
}
...
pub async fn lfs_stat<S: Storage>(
    ...
    crate::fs::stat::lfs_stat_(lfs, caches, path, info).await
}
...
pub async fn lfs_getattr<S: Storage>(
    ...
    crate::fs::attr::lfs_getattr_(lfs, caches, path, r#type, buffer).await
}
...
pub async fn lfs_setattr<S: Storage>(
    ...
    crate::fs::attr::lfs_setattr_(lfs, caches, path, r#type, buffer).await
}
...
pub async fn lfs_removeattr<S: Storage>(
    ...
    crate::fs::attr::lfs_removeattr_(lfs, caches, path, r#type).await
}
...
pub async fn lfs_file_open<S: Storage>(
    ...
    crate::file::ops::lfs_file_open_(lfs, caches, file, path as *const i8, flags).await
}

/// Open a file with extra configuration. Per lfs.h lfs_file_opencfg (lfs.c:6193-6197).
#[inline(never)]
pub async fn lfs_file_opencfg<S: Storage>(
    lfs: &mut Lfs<S>,
    caches: &mut LfsCaches,
    file: *mut LfsFile,
    path: *const u8,
    ...
    crate::file::ops::lfs_file_opencfg_(lfs, caches, file, path as *const i8, flags, config).await
}

/// Close a file. Per lfs.h lfs_file_close (lfs.c:6227-6231).
#[inline(never)]
pub async fn lfs_file_close<S: Storage>(
    lfs: &mut Lfs<S>,
    caches: &mut LfsCaches,
    file: *mut LfsFile,
) -> i32 {
    crate::file::ops::lfs_file_close_(lfs, caches, file).await
}

/// Synchronize a file on storage. Per lfs.h lfs_file_sync (lfs.c:6263-6267).
#[inline(never)]
pub async fn lfs_file_sync<S: Storage>(
    lfs: &mut Lfs<S>,
    caches: &mut LfsCaches,
    file: *mut LfsFile,
) -> i32 {
    crate::file::ops::lfs_file_sync_(lfs, caches, file).await
}
...
pub async fn lfs_file_read<S: Storage>(
    ...
    crate::file::ops::lfs_file_read_(lfs, caches, file, buffer).await
}
...
pub async fn lfs_file_write<S: Storage>(
    ...
    crate::file::ops::lfs_file_write_(lfs, caches, file, buffer).await
}
...
pub async fn lfs_file_seek<S: Storage>(
    ...
    crate::file::ops::lfs_file_seek_(lfs, caches, file, off, whence).await
}

/// Truncate the size of the file. Per lfs.h lfs_file_truncate (lfs.c:6471-6475).
#[inline(never)]
pub async fn lfs_file_truncate<S: Storage>(
    lfs: &mut Lfs<S>,
    caches: &mut LfsCaches,
    file: *mut LfsFile,
    size: lfs_off_t,
) -> i32 {
    crate::file::ops::lfs_file_truncate_(lfs, caches, file, size).await
}
...
#[inline(never)]
pub async fn lfs_file_rewind<S: Storage>(
    lfs: &mut Lfs<S>,
    caches: &mut LfsCaches,
    file: *mut LfsFile,
) -> i32 {
    crate::file::ops::lfs_file_rewind_(lfs, caches, file).await
}
...
#[inline(never)]
pub async fn lfs_mkdir<S: Storage>(
    lfs: &mut Lfs<S>,
    caches: &mut LfsCaches,
    path: *const u8,
) -> i32 {
    crate::fs::mkdir::lfs_mkdir_(lfs, caches, path).await
}
...
pub async fn lfs_dir_open<S: Storage>(
    ...
    crate::dir::open::lfs_dir_open_(lfs, caches, dir, path).await
}
...
pub async fn lfs_dir_read<S: Storage>(
    ...
    crate::dir::open::lfs_dir_read_(lfs, caches, dir, info).await
}
...
pub async fn lfs_dir_seek<S: Storage>(
    ...
    crate::dir::open::lfs_dir_seek_(lfs, caches, dir, off).await
}
...
#[inline(never)]
pub async fn lfs_dir_rewind<S: Storage>(
    lfs: &mut Lfs<S>,
    caches: &mut LfsCaches,
    dir: *mut LfsDir,
) -> i32 {
    crate::dir::open::lfs_dir_rewind_(lfs, caches, dir).await
}
...
pub async fn lfs_fs_stat<S: Storage>(
    ...
    crate::fs::lfs_fs_stat_(lfs, caches, fsinfo).await
}

/// Find the current size of the filesystem. Per lfs.h lfs_fs_size (lfs.c:6449-6453).
#[inline(never)]
pub async fn lfs_fs_size<S: Storage>(lfs: &mut Lfs<S>, caches: &mut LfsCaches) -> lfs_ssize_t {
    crate::fs::stat::lfs_fs_size_(lfs, caches).await
}
...
pub async fn lfs_fs_traverse<S: Storage>(
    ...
    crate::fs::traverse::lfs_fs_traverse_(lfs, caches, cb, false).await
}

/// Attempt to make the filesystem consistent. Per lfs.h lfs_fs_mkconsistent (lfs.c:6479-6483).
#[inline(never)]
pub async fn lfs_fs_mkconsistent<S: Storage>(lfs: &mut Lfs<S>, caches: &mut LfsCaches) -> i32 {
    crate::fs::consistent::lfs_fs_mkconsistent_(lfs, caches).await
}

/// Attempt any janitorial work. Per lfs.h lfs_fs_gc (lfs.c:6495-6499).
#[inline(never)]
pub async fn lfs_fs_gc<S: Storage>(lfs: &mut Lfs<S>, caches: &mut LfsCaches) -> i32 {
    crate::fs::consistent::lfs_fs_gc_(lfs, caches).await
}

/// Force consistency (deorphan, demove, desuperblock). For testing.
#[doc(hidden)]
pub async fn lfs_fs_forceconsistency<S: Storage>(lfs: &mut Lfs<S>, caches: &mut LfsCaches) -> i32 {
    crate::fs::superblock::lfs_fs_forceconsistency(lfs, caches).await
}
...
pub async fn lfs_fs_grow<S: Storage>(
    ...
    crate::fs::grow::lfs_fs_grow_(lfs, caches, block_count).await
}
